...
export function consultancyMarkdown(language: Language) {
  ...
  if (language === "ja") {
    return [
      ...
      "## 担当者",
      "",
      "スティアン・フロイスタイン（ローマ字表記: Stian Froeystein、ノルウェー語表記: Stian Frøystein）は、株式会社フロイスタインコンサルティング代表取締役、Intility AS Lead Site Reliability Engineerです。Linux、クラウド基盤、Kubernetes、SREに約11年の実務経験があります。",
      "",
