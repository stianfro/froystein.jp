...
export function homeMarkdown(language: Language) {
  if (language === "ja") {
    return [
      ...
      "",
      `[技術コンサルティング](${absoluteUrl("/ja/consulting/")})`,
      "",
  ...
  return [
    ...
    "",
    `[Technical consultancy](${absoluteUrl("/consulting/")})`,
    "",
...
export function consultancyMarkdown(language: Language) {
  if (language === "ja") {
    return [
      ...
      "## お問い合わせ",
      "",
      "技術コンサルティングに関するご相談は、LinkedInからご連絡ください。",
      "",
  ...
  return [
    ...documentHeader(
      ...
      "Froystein Consulting provides consultancy services for Kubernetes and cloud native technology.",
      "/consulting/",
      "/ja/consulting.md",
      "日本語のMarkdown版",
    ),
    ...
    "## Contact",
    "",
    "For technical consultancy enquiries, contact Stian through LinkedIn.",
    "",
...
export function contactMarkdown(language: Language) {
  if (language === "ja") {
    return [
      ...
      "",
      `[技術コンサルティングの詳細](${absoluteUrl("/ja/consulting/")})`,
      "",
      `[LinkedInで問い合わせる](${linkedinUrl})`,
      "",
      "## 国際業務・取材のご相談",
  ...
  return [
    ...
    "",
    `[Technical consultancy details](${absoluteUrl("/consulting/")})`,
    "",
    `[Contact via LinkedIn](${linkedinUrl})`,
    "",
