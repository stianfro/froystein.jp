...
- [Software projects](https://www.froystein.jp/projects.md): Kemuri and Tabiji software project descriptions and source links
- [Profile and media](https://www.froystein.jp/media.md): Profile, languages, topics, availability, and dated television appearances
- [Contact](https://www.froystein.jp/contact.md): Technical consultancy areas and separate contact routes for consultancy and international services
...
- [ソフトウェアプロジェクト](https://www.froystein.jp/ja/projects.md): KemuriとTabijiの概要とソースコードへのリンク
- [プロフィール・取材](https://www.froystein.jp/ja/media.md): プロフィール、言語、対応テーマ、出演形式、テレビ出演歴、連絡先
- [お問い合わせ](https://www.froystein.jp/ja/contact.md): 技術コンサルティングの対応分野と、技術相談・国際業務・取材の窓口
